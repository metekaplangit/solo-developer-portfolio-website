...
# lavender side of the lettered tile on the game's newest icon
# (store-assets/icons/icons-2026-09-06-2041-one-tile-w-78/AppIcon-1024.png in
# that project, sampled at the tile's lower edge). The game's world is a night
...
features:
  - Trace letters on a wheel to spell the words of the crossword above it
  - Three journeys, each twenty places and five hundred stops long
  - A bonus jar for the extra words you find, which pays out when it is full
  - A daily puzzle, a daily gift, and daily goals
...
Trace letters on a wheel to spell words, and each one you find drops into the
crossword above it. Fill the crossword and the journey moves on to its next
stop.
...
A word that fits no answer in the crossword still goes somewhere. It lands in
the bonus jar, and a full jar pays out.
